...
internal sealed class TrendSettingCard : Card, IRegisterable
{
	public static void Register(IPluginPackage<IModManifest> package, IModHelper helper)
	{
		helper.Content.Cards.RegisterCard(MethodBase.GetCurrentMethod()!.DeclaringType!.Name, new()
		{
			...
			Art = helper.Content.Sprites.RegisterSpriteOrDefault(package.PackageRoot.GetRelativeFile("assets/Cards/TrendSetting.png"), StableSpr.cards_colorless).Sprite,
	...
	public override CardData GetData(State state)
		=> upgrade switch
		{
			Upgrade.A => new() { cost = 0, buoyant = true, exhaust = true },
			_ => new() { cost = 1, buoyant = true, exhaust = true },
		};
