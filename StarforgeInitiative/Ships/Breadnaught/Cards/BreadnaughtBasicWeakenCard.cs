...
internal sealed class BreadnaughtBasicWeakenCard : CannonColorless, IRegisterable
{
	...
	public override CardData GetData(State state)
		=> upgrade switch
		{
			Upgrade.B => new() { cost = 2, temporary = true, exhaust = true, artTint = "ff3366" },
			Upgrade.A => new() { cost = 0, temporary = true, exhaust = true, artTint = "ff3366" },
			_ => new() { cost = 1, temporary = true, exhaust = true, artTint = "ff3366" },
		};
