...
public sealed class DuoArtifactDefinition
{
	...
	public static readonly IReadOnlyList<DuoArtifactDefinition> Definitions = [
		...
		new(typeof(DizzyIsaacArtifact), [Deck.dizzy, Deck.goat], I18n.DizzyIsaacArtifactName, I18n.DizzyIsaacArtifactTooltip, "DizzyIsaac", "action.spawn", new(() => Instance.KokoroApi.GetOxidationStatusTooltip(StateExt.Instance ?? DB.fakeState, (StateExt.Instance ?? DB.fakeState).ship)), "status.corrodeAlt"),
		...
		new(typeof(IsaacPeriArtifact), [Deck.goat, Deck.peri], I18n.IsaacPeriArtifactName, I18n.IsaacPeriArtifactTooltip, "IsaacPeri", "status.overdriveAlt", "status.powerdriveAlt", I18n.FluxAltGlossary),
		new(typeof(IsaacRiggsArtifact), [Deck.goat, Deck.riggs], I18n.IsaacRiggsArtifactName, I18n.IsaacRiggsArtifactTooltip, "IsaacRiggs", "status.evade", "status.droneShift"),
