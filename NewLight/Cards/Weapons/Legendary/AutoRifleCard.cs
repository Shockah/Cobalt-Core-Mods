...
internal class AutoRifleCard : LegendaryWeaponCard, WeaponCard.IRepeatable, IRegisterable
{
	protected override Dictionary<WeaponElement, string> ElementWeaponNames { get; } = new()
	{
		{ WeaponElement.Kinetic, "Breakneck" },
		{ WeaponElement.Arc, "Shadow Price" },
		{ WeaponElement.Solar, "The Ringing Nail" },
		{ WeaponElement.Void, "Gnawing Hunger" },
		{ WeaponElement.Stasis, "Horror Story" },
		{ WeaponElement.Strand, "Rufus's Fury" },
	};
	...
	public new static void Register(IPluginPackage<IModManifest> package, IModHelper helper)
	{
		var entry = helper.Content.Cards.RegisterCard(MethodBase.GetCurrentMethod()!.DeclaringType!.Name, new()
		{
			...
			Name = ModEntry.Instance.AnyLocalizations.Bind(["Card", "Weapon", "Legendary", "AutoRifle"]).Localize,
		});
