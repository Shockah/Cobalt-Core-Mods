...
internal class LightweightSwordCard : LegendaryWeaponCard, WeaponCard.IUsesAmmo.IOnlyOne, WeaponCard.IRepeatable, WeaponCard.ICannotCrit, IRegisterable
{
	protected override Dictionary<WeaponElement, string> ElementWeaponNames { get; } = new()
	{
		{ WeaponElement.Arc, "Goldtusk" },
		{ WeaponElement.Solar, "Abide the Return" },
		{ WeaponElement.Void, "Sullen Claw" },
		{ WeaponElement.Stasis, "Zephyr" },
		{ WeaponElement.Strand, "Abyssal Edge" },
	};
	...
	public new static void Register(IPluginPackage<IModManifest> package, IModHelper helper)
	{
		var entry = helper.Content.Cards.RegisterCard(MethodBase.GetCurrentMethod()!.DeclaringType!.Name, new()
		{
			...
			Name = ModEntry.Instance.AnyLocalizations.Bind(["Card", "Weapon", "Legendary", "LightweightSword"]).Localize,
		});
