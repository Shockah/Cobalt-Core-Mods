...
internal class MakeYourOwnFateCard : GuardianCard, IRegisterable
{
	public static void Register(IPluginPackage<IModManifest> package, IModHelper helper)
	{
		helper.Content.Cards.RegisterCard(MethodBase.GetCurrentMethod()!.DeclaringType!.Name, new()
		{
			...
			Name = ModEntry.Instance.AnyLocalizations.Bind(["Card", "Generic", "MakeYourOwnFate", "Name"]).Localize,
		});
	}

	public override CardData GetData(State state)
	{
		var data = base.GetData(state) with { description = ModEntry.Instance.Localizations.Localize(["Card", "Generic", "MakeYourOwnFate", "Description", upgrade.ToString()]) };
