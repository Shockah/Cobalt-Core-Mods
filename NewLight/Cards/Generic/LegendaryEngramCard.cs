...
internal class LegendaryEngramCard : GuardianCard, IRegisterable
{
	public static void Register(IPluginPackage<IModManifest> package, IModHelper helper)
	{
		helper.Content.Cards.RegisterCard(MethodBase.GetCurrentMethod()!.DeclaringType!.Name, new()
		{
			...
			Name = ModEntry.Instance.AnyLocalizations.Bind(["Card", "Generic", "LegendaryEngram", "Name"]).Localize,
		});
	}

	public override CardData GetData(State state)
	{
		var data = base.GetData(state) with { description = ModEntry.Instance.Localizations.Localize(["Card", "Generic", "LegendaryEngram", "Description", upgrade.ToString()]) };
	...
	public override List<CardAction> GetActions(State s, Combat c)
		=> [
			new ACardOffering
			{
				...
				rarityOverride = LegendaryWeaponCard.RARITY,
